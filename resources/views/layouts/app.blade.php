...
<html lang="en">
    <head>
        ...
        <!-- Stylesheet
            ============================================= -->
        <link rel="stylesheet" type="text/css" href="{{URL::to('assets/vendor/bootstrap/css/bootstrap.min-1.css')}}">
        <link rel="stylesheet" type="text/css" href="{{URL::to('assets/vendor/font-awesome/css/all.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{URL::to('assets/vendor/owl.carousel/assets/owl.carousel.min-1.css')}}">
        <link rel="stylesheet" type="text/css" href="{{URL::to('assets/vendor/owl.carousel/assets/owl.theme.default.min-1.css')}}">
        <link rel="stylesheet" type="text/css" href="{{URL::to('assets/vendor/jquery-ui/jquery-ui-1.css')}}">
        <link rel="stylesheet" type="text/css" href="{{URL::to('assets/vendor/daterangepicker/daterangepicker-1.css')}}">
        <link rel="stylesheet" type="text/css" href="{{URL::to('assets/css/stylesheet-1.css')}}">
    ...
    <body>
                                    ...
                                    <ul class="navbar-nav">
                                        <!-- <li class="dropdown active">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="dropdown">
                                                    <a class="dropdown-item dropdown-toggle" href="#">Index 1</a>
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="index-1.html">Recharge or Bill Payment</a></li>
                                                        <li><a class="dropdown-item" href="booking-hotels.html">Booking</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown">
                                                    <a class="dropdown-item dropdown-toggle" href="#">Index 2</a>
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="index-2-1.html">Recharge or Bill Payment</a></li>
                                                        <li><a class="dropdown-item" href="booking-hotels-2.html">Booking</a></li>
                                                    </ul>
                                                </li>
                                                <li><a class="dropdown-item" href="index-3-1.html">Index 3 - (Recharge & Bill)</a></li>
                                                <li><a class="dropdown-item" href="index-4-1.html">Index 4 - (Booking)</a></li>
                                                <li><a class="dropdown-item" href="index-5-1.html">Index 5 - (Recharge & Bill)</a></li>
                                                <li><a class="dropdown-item" href="index-6-1.html">Index 6 - (Booking)</a></li>
                                                <li><a class="dropdown-item" href="index-7-1.html">Index 7 - (Recharge & Bill)</a></li>
                                                <li><a class="dropdown-item" href="index-8-1.html">Index 8 - (Booking)</a></li>
                                                <li><a class="dropdown-item" href="index-9-1.html">Index 9 - (Booking)</a></li>
                                                <li><a class="dropdown-item" href="index-10-1.html">Index 10 - (Recharge & Bill)</a></li>
                                                <li><a class="dropdown-item" href="index-11.html">Index 11 - (Mobile Top-Up)</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            <a class="dropdown-toggle" href="#">Recharge & Bill Payment</a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <ul class="dropdown-mega-submenu">
                                                                <li class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="index-1.html">Layout 1</a></li>
                                                                        <li><a class="dropdown-item" href="index-2-1.html">Layout 2</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown">
                                                                    <a class="dropdown-item dropdown-toggle" href="#">DTH</a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="recharge-bill-dth-1.html">Layout 1</a></li>
                                                                        <li><a class="dropdown-item" href="recharge-bill-dth-2-1.html">Layout 2</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown">
                                                                    <a class="dropdown-item dropdown-toggle" href="#">Data Card</a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="recharge-bill-datacard-1.html">Layout 1</a></li>
                                                                        <li><a class="dropdown-item" href="recharge-bill-datacard-2.html">Layout 2</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown">
                                                                    <a class="dropdown-item dropdown-toggle" href="#">Broadband</a>
                                                                    <ul class="dropdown-menu">
                                                                ...
                                                                <li class="dropdown">
                                                                    <a class="dropdown-item dropdown-toggle" href="#">Landline</a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="recharge-bill-landline.html">Layout 1</a></li>
                                                                        <li><a class="dropdown-item" href="recharge-bill-landline-2-1.html">Layout 2</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown">
                                                                    <a class="dropdown-item dropdown-toggle" href="#">Cable TV</a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="recharge-bill-cabletv-1.html">Layout 1</a></li>
                                                                        <li><a class="dropdown-item" href="recharge-bill-cabletv-2-1.html">Layout 2</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown">
                                                                    <a class="dropdown-item dropdown-toggle" href="#">Electricity</a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="recharge-bill-electricity-1.html">Layout 1</a></li>
                                                                        <li><a class="dropdown-item" href="recharge-bill-electricity-2-1.html">Layout 2</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown">
                                                                    <a class="dropdown-item dropdown-toggle" href="#">Metro</a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="recharge-bill-metro-1.html">Layout 1</a></li>
                                                                        <li><a class="dropdown-item" href="recharge-bill-metro-2-1.html">Layout 2</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown">
                                                                    <a class="dropdown-item dropdown-toggle" href="#">Gas</a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="recharge-bill-gas-1.html">Layout 1</a></li>
                                                                        <li><a class="dropdown-item" href="recharge-bill-gas-2-1.html">Layout 2</a></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="dropdown">
                                                                    <a class="dropdown-item dropdown-toggle" href="#">Water</a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="recharge-bill-water-1.html">Layout 1</a></li>
                                                                        <li><a class="dropdown-item" href="recharge-bill-water-2-1.html">Layout 2</a></li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <ul class="dropdown-mega-submenu">
                                                                ...
                                                                <li><a class="dropdown-item" href="recharge-plans-1.html">Recharge - Plans</a></li>
                                        ...
                                        <li class="dropdown dropdown-mega">
                                            <a class="dropdown-toggle" href="#">Booking</a>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <div class="row">
                                                        <div class="col-lg">
                                                        ...
                                                        <div class="col-lg">
                                                            ...
                                                            <ul class="dropdown-mega-submenu">
                                                                <li><a class="dropdown-item" href="booking-flights-1.html">Home Layout 1</a></li>
                                                                <li><a class="dropdown-item" href="booking-flights-2-1.html">Home Layout 2</a></li>
                                                                <li><a class="dropdown-item" href="booking-flights-one-way-1.html">One Way Trip List</a></li>
                                                                <li><a class="dropdown-item" href="booking-flights-round-trip-1.html">Round Trip List</a></li>
                                                                <li><a class="dropdown-item" href="booking-flights-confirm-details-1.html">Confirm Details</a></li>
                                                        ...
                                                        <div class="col-lg">
                                                            ...
                                                            <ul class="dropdown-mega-submenu">
                                                                <li><a class="dropdown-item" href="booking-trains-1.html">Home Layout 1</a></li>
                                                                <li><a class="dropdown-item" href="booking-trains-2-1.html">Home Layout 2</a></li>
                                                                <li><a class="dropdown-item" href="booking-trains-list-1.html">Trains List</a></li>
                                                                <li><a class="dropdown-item" href="booking-trains-confirm-details-1.html">Confirm Details</a></li>
                                                        ...
                                                        <div class="col-lg">
                                                            ...
                                                            <ul class="dropdown-mega-submenu">
                                                                <li><a class="dropdown-item" href="booking-bus-1.html">Home Layout 1</a></li>
                                                                <li><a class="dropdown-item" href="booking-bus-2-1.html">Home Layout 2</a></li>
                                                                <li><a class="dropdown-item" href="booking-bus-list-1.html">Bus List</a></li>
                                                                <li><a class="dropdown-item" href="booking-bus-confirm-details-1.html">Confirm Details</a></li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="index-1.html">Light Version (Default)</a></li>
                                                        <li><a class="dropdown-item" href="index-7-1.html">Left Navigation (Alternate)</a></li>
                                                        <li><a class="dropdown-item" href="index-4-1.html">Dark Version</a></li>
                                                        <li><a class="dropdown-item" href="index-5-1.html">Primary Version</a></li>
                                                        <li><a class="dropdown-item" href="index-8-1.html">Transparent</a></li>
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="index-1.html">Light Version (Default)</a></li>
                                                        <li><a class="dropdown-item" href="index-3-1.html">Dark Version</a></li>
                                                        <li><a class="dropdown-item" href="index-6-1.html">Primary Version</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown">
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="index-1.html">Light Version Default</a></li>
                                                        <li><a class="dropdown-item" href="index-7-1.html">Alternate Version</a></li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="about-us-1.html">About Us</a></li>
                                                <li class="dropdown">
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="profile-1.html">Personal Information</a></li>
                                                ...
                                                <li><a class="dropdown-item" href="payment-1.html">Payment</a></li>
                                                <li><a class="dropdown-item" href="payment-2.html">Payment 2</a></li>
                                                <li><a class="dropdown-item" href="help.html">Help</a></li>
                                                <li><a class="dropdown-item" href="faq-1.html">Faq</a></li>
                                                <li><a class="dropdown-item" href="support-1.html">Support</a></li>
                                                <li><a class="dropdown-item" href="contact-us-1.html">Contact Us</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="featured-box text-center">
                                    ...
                                    <h4>24X7 Support</h4>
                                    <p>We're here to help. Have a query and need help ? 
                                        <a href="#">Click here</a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 mb-3 mb-md-0">
                            ...
                            <ul class="payments-types">
                                <li>
                                    ...
                                    <img data-toggle="tooltip" src="assets/images/payment/visa-1.png" alt="visa" title="Visa">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">
                                    <img data-toggle="tooltip" src="assets/images/payment/discover-1.png" alt="discover" title="Discover">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">
                                    <img data-toggle="tooltip" src="assets/images/payment/paypal-1.png" alt="paypal" title="PayPal">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">
                                    <img data-toggle="tooltip" src="assets/images/payment/american-1.png" alt="american express" title="American Express">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">
                                    <img data-toggle="tooltip" src="assets/images/payment/mastercard-1.png" alt="discover" title="Discover">
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-md-4 d-flex align-items-md-end flex-column">
                            ...
                            <ul class="social-icons">
                                <li class="social-icons-facebook">
                                    <a data-toggle="tooltip" href="../../index-1.htm" target="_blank" title="Facebook">
                                    <i class="fab fa-facebook-f"></i>
                                    </a>
                                </li>
                                <li class="social-icons-twitter">
                                    <a data-toggle="tooltip" href="../../index-2.htm" target="_blank" title="Twitter">
                                    <i class="fab fa-twitter"></i>
                                    </a>
                                </li>
                                <li class="social-icons-google">
                                    <a data-toggle="tooltip" href="../../index-3.htm" target="_blank" title="Google">
                                    <i class="fab fa-google"></i>
                                    </a>
                                </li>
                                <li class="social-icons-linkedin">
                                    <a data-toggle="tooltip" href="../../index-4.htm" target="_blank" title="Linkedin">
                                    <i class="fab fa-linkedin-in"></i>
                                    </a>
                                </li>
                                <li class="social-icons-youtube">
                                    <a data-toggle="tooltip" href="../../index-5.htm" target="_blank" title="Youtube">
                                    <i class="fab fa-youtube"></i>
                                    </a>
                                </li>
                                <li class="social-icons-instagram">
                                    <a data-toggle="tooltip" href="../../index-6.htm" target="_blank" title="Instagram">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0">
                    <div class="modal-body py-4 px-0">
                        <button type="button" class="close close-outside" data-dismiss="modal" aria-label="Close">
                        ...
                        <div class="row">
                            <div class="col-11 col-md-10 mx-auto">
                                <ul class="nav nav-tabs nav-justified mb-4" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-5 line-height-3" href="" data-toggle="modal" data-target="#signup-modal" data-dismiss="modal">Sign Up</a>
                                    </li>
                                </ul>
                                ...
                                <form id="loginForm" method="post">
                                    ...
                                    <div class="row my-4">
                                        ...
                                        <div class="col text-2 text-right">
                                            <a class="btn-link" href="" data-toggle="modal" data-target="#forgot-password-modal" data-dismiss="modal">Forgot Password ?</a>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex  flex-column align-items-center mb-3">
                                    <ul class="social-icons social-icons-colored social-icons-circle">
                                        <li class="social-icons-facebook">
                                            <a href="#" data-toggle="tooltip" data-original-title="Log In with Facebook">
                                            <i class="fab fa-facebook-f"></i>
                                            </a>
                                        </li>
                                        <li class="social-icons-twitter">
                                            <a href="#" data-toggle="tooltip" data-original-title="Log In with Twitter">
                                            <i class="fab fa-twitter"></i>
                                            </a>
                                        </li>
                                        <li class="social-icons-google">
                                            <a href="#" data-toggle="tooltip" data-original-title="Log In with Google">
                                            <i class="fab fa-google"></i>
                                            </a>
                                        </li>
                                        <li class="social-icons-linkedin">
                                            <a href="#" data-toggle="tooltip" data-original-title="Log In with Linkedin">
                                            <i class="fab fa-linkedin-in"></i>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                <p class="text-2 text-center mb-0">New to Quickai? 
                                    <a class="btn-link" href="" data-toggle="modal" data-target="#signup-modal" data-dismiss="modal">Sign Up</a>
                                </p>
                            </div>
                        </div>
                        <!-- Login Form End -->
                    ...
                    <div class="modal-body py-4 px-0">
                        ...
                        <div class="row">
                            <div class="col-11 col-md-10 mx-auto">
                                <ul class="nav nav-tabs nav-justified mb-4" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link text-5 line-height-3" href="" data-toggle="modal" data-target="#login-modal" data-dismiss="modal">Log In</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-5 line-height-3 active">Sign Up</a>
                                    </li>
                                </ul>
                                ...
                                <div class="d-flex  flex-column align-items-center mb-3">
                                    <ul class="social-icons social-icons-colored social-icons-circle">
                                        <li class="social-icons-facebook">
                                            <a href="#" data-toggle="tooltip" data-original-title="Sign Up with Facebook">
                                            <i class="fab fa-facebook-f"></i>
                                            </a>
                                        </li>
                                        <li class="social-icons-twitter">
                                            <a href="#" data-toggle="tooltip" data-original-title="Sign Up with Twitter">
                                            <i class="fab fa-twitter"></i>
                                            </a>
                                        </li>
                                        <li class="social-icons-google">
                                            <a href="#" data-toggle="tooltip" data-original-title="Sign Up with Google">
                                            <i class="fab fa-google"></i>
                                            </a>
                                        </li>
                                        <li class="social-icons-linkedin">
                                            <a href="#" data-toggle="tooltip" data-original-title="Sign Up with Linkedin">
                                            <i class="fab fa-linkedin-in"></i>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <p class="text-2 text-center mb-0">Already have an account? 
                                    <a class="btn-link" href="" data-toggle="modal" data-target="#login-modal" data-dismiss="modal">Log In</a>
                                </p>
                            </div>
                        </div>
                        <!-- Sign Up Form End -->
                        ...
                        <div class="row">
                            <div class="col-11 col-md-10 mx-auto">
                                ...
                                <p class="text-center mb-0">
                                    <a class="btn-link" href="" data-toggle="modal" data-target="#login-modal" data-dismiss="modal">Return to Log In</a>
                                    <span class="text-muted mx-3">|</span>
                                    <a class="btn-link" href="" data-toggle="modal" data-target="#otp-modal" data-dismiss="modal">Request OTP</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="modal-body py-4 px-0">
                        ...
                        <div class="row">
                            <div class="col-11 col-md-10 mx-auto">
                                ...
                                <p class="text-center">
                                    <img class="img-fluid" src="assets/images/otp-icon.png" alt="verification">
                                </p>
                                <p class="text-muted text-3 text-center">Please enter the OTP (one time password) to verify your account. A Code has been sent to 
                                    <span class="text-dark text-4">+1*******179</span>
                                </p>
                                ...
                                <p class="text-2 text-center mb-0">
                                    <a class="btn-link" href="#">Call me</a>
                                </p>
                            </div>
                        </div>
                        <!-- OTP Form End -->
        ...
        <!-- OTP Modal End -->
        <!-- Script -->
        <script src="{{URL::to('assets/vendor/jquery/jquery.min-1.js')}}"></script>
        <script src="{{URL::to('assets/vendor/jquery-ui/jquery-ui.min-1.js')}}"></script>
        <script src="{{URL::to('assets/vendor/bootstrap/js/bootstrap.bundle.min-1.js')}}"></script>
        <script src="{{URL::to('assets/vendor/owl.carousel/owl.carousel.min-1.js')}}"></script>
        <script src="{{URL::to('assets/vendor/easy-responsive-tabs/easy-responsive-tabs-1.js')}}"></script>
        <script src="{{URL::to('assets/vendor/bootstrap-spinner/bootstrap-spinner-1.js')}}"></script>
        <script src="{{URL::to('assets/vendor/daterangepicker/moment.min-1.js')}}"></script>
        <script src="{{URL::to('assets/vendor/daterangepicker/daterangepicker-1.js')}}"></script>
        <script>
            $(function() {
             'use strict';
        ...
        <script src="{{URL::to('assets/js/theme-1.js')}}"></script>
        @livewireScripts
    </body>
</html>