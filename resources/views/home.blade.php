            ...
            <div class="col-md-9 mt-4 mt-md-0">
                <div class="bg-light shadow-md rounded py-4">
                    ...
                    <div class="flight-list">
                        @foreach($search as $s)
                            <div class="flight-item">
                                <div class="row align-items-center flex-row pt-4 pb-2 px-3">
                                    <div class="col col-sm-2 text-center d-lg-flex company-info"> <span class="align-middle"><img class="img-fluid" alt="" src="images\brands\flights\indigo.png"> </span> <span class="align-middle ml-lg-2"> <span class="d-block text-1 text-dark">IndiGo</span> <small class="text-muted d-block">6E-2726</small> </span> </div>
                        ...
                        <div class="flight-item">
                            <div class="row align-items-center flex-row pt-4 pb-2 px-3">
                                <div class="col col-sm-2 text-center d-lg-flex company-info"> <span class="align-middle"><img class="img-fluid" alt="" src="images\brands\flights\jetairways.png"> </span> <span class="align-middle ml-lg-2"> <span class="d-block text-1 text-dark">JetAirways</span> <small class="text-muted d-block">6E-2726</small> </span> </div>
                                <div class="col col-sm-2 text-center time-info"> <span class="text-4">23:00</span> <small class="text-muted d-none d-sm-block">Delhi</small> </div>
                                <div class="col-sm-2 text-center d-none d-sm-block time-info"> <span class="text-3">18h 55m</span> <small class="text-muted d-none d-sm-block">Non Stop</small> </div>
                                <div class="col col-sm-2 text-center time-info"> <span class="text-4">18:15</span> <small class="text-muted d-none d-sm-block">Sydney</small> </div>
                        ...
                        <div class="flight-item">
                            <div class="row align-items-center flex-row pt-4 pb-2 px-3">
                                <div class="col col-sm-2 text-center d-lg-flex company-info"> <span class="align-middle"><img class="img-fluid" alt="" src="images\brands\flights\spicejet.png"> </span> <span class="align-middle ml-lg-2"> <span class="d-block text-1 text-dark">SpiceJet</span> <small class="text-muted d-block">6E-2726</small> </span> </div>
                                <div class="col col-sm-2 text-center time-info"> <span class="text-4">23:00</span> <small class="text-muted d-none d-sm-block">Delhi</small> </div>
                                <div class="col-sm-2 text-center d-none d-sm-block time-info"> <span class="text-3">18h 55m</span> <small class="text-muted d-none d-sm-block">Non Stop</small> </div>
                                <div class="col col-sm-2 text-center time-info"> <span class="text-4">18:15</span> <small class="text-muted d-none d-sm-block">Sydney</small> </div>
                        ...
                        <div class="flight-item">
                            <div class="row align-items-center flex-row pt-4 pb-2 px-3">
                                <div class="col col-sm-2 text-center d-lg-flex company-info"> <span class="align-middle"><img class="img-fluid" alt="" src="images\brands\flights\airindia.png"> </span> <span class="align-middle ml-lg-2"> <span class="d-block text-1 text-dark">AirIndia</span> <small class="text-muted d-block">6E-2726</small> </span> </div>
                                <div class="col col-sm-2 text-center time-info"> <span class="text-4">23:00</span> <small class="text-muted d-none d-sm-block">Delhi</small> </div>
                                <div class="col-sm-2 text-center d-none d-sm-block time-info"> <span class="text-3">18h 55m</span> <small class="text-muted d-none d-sm-block">Non Stop</small> </div>
                                <div class="col col-sm-2 text-center time-info"> <span class="text-4">18:15</span> <small class="text-muted d-none d-sm-block">Sydney</small> </div>
                        ...
                        <div class="flight-item">
                            <div class="row align-items-center flex-row pt-4 pb-2 px-3">
                                <div class="col col-sm-2 text-center d-lg-flex company-info"> <span class="align-middle"><img class="img-fluid" alt="" src="images\brands\flights\goair.png"> </span> <span class="align-middle ml-lg-2"> <span class="d-block text-1 text-dark">GoAir</span> <small class="text-muted d-block">6E-2726</small> </span> </div>
                                <div class="col col-sm-2 text-center time-info"> <span class="text-4">23:00</span> <small class="text-muted d-none d-sm-block">Delhi</small> </div>
                                <div class="col-sm-2 text-center d-none d-sm-block time-info"> <span class="text-3">18h 55m</span> <small class="text-muted d-none d-sm-block">Non Stop</small> </div>
                                <div class="col col-sm-2 text-center time-info"> <span class="text-4">18:15</span> <small class="text-muted d-none d-sm-block">Sydney</small> </div>
                                <div class="col col-sm-2 text-right text-dark text-6 price">$775</div>
